        ...
        <>
            ...
            <div className="w-full flex flex-col">
                ...
                <div className='mt-3 mb-4 text-center'>
                    ...
                    { contextData?.image?
                        <div className="inline-flex select-none items-center justify-center relative overflow-hidden">
                            <Image className="w-16 h-16 rounded-full" src={contextData?.image} alt={contextData?.name} />
                        </div>
                    :
                        <div className="relative inline-flex select-none items-center justify-center w-16 h-16 overflow-hidden bg-gray-100 rounded-full">
                            <span className="font-medium text-xl text-gray-600" >{ contextData?.shortname }</span>
                        </div> 
                    }

                    <div className="text-sm text-gray-500 mt-1">{ textUserId }</div>
                </div>
                ...
                <div className="text-sm mb-2 mt-4" >
                    <div className="underline underline-offset-4 cursor-pointer font-semibold text-gray-600 hover:text-gray-500"
                        onClick={()=>{setDisplayView('recover')}}
                        >
