...
const copyrightStatement = "&copy; 2023 WebiGus. Todos os direitos reservados.";

const newsletter = {
    title: "Assine nossa newsletter",
    desc: "As últimas notícias, artigos e recursos, enviados semanalmente para sua caixa de entrada.",
    button: {
        text: "Subscrever"
    },
    input: {
...
export { navigation, copyrightStatement, newsletter }
