...
const SignUp = ({ textFName, setTextFName, textLName, setTextLName, textUserId, setTextUserId, textPassword, setTextPassword, setDisplayView, actionEvent }) => {
    ...
    const [ statusFName, setStatusFName ] = useState({});
    const [ statusLName, setStatusLName ] = useState({});
    ...
    const [ isValidFName, setIsValidFName ] = useState(textFName?true:null);
    const [ isValidLName, setIsValidLName ] = useState(textLName?true:null);
    ...
    const handleWithFNameInput = (value) => {
        setTextFName(value)

        setStatusFName({status:null, message:null})
    ...
    const handleWithLNameInput = (value) => {
        setTextLName(value)

        setStatusLName({status:null, message:null})
    ...
    return (
        <>
            ...
            <div className="w-full flex flex-col">
                ...
                <div className='flex justify-center mt-3 items-stretch flex-row text-center'>
                    <div>
                ...
                <div className="inline-flex items-center justify-center w-full">
                    ...
                    <span className="absolute px-3 font-medium text-gray-900 -translate-x-1/2 bg-white left-1/2">ou</span>
                </div>
                ...
                <div className='mb-3' >
                    <FloatingLabel
                        ...
                        value={textFName}
                        onTextEvent={(e)=>{handleWithFNameInput(e.target.value)}}
                        status={statusFName?.status}
                        message={statusFName?.message}
                        />
                </div>
                ...
                <div className='mb-3' >
                    <FloatingLabel
                        ...
                        placeholder={"Apelido"}
                        value={textLName}
                        onTextEvent={(e)=>{handleWithLNameInput(e.target.value)}}
                        status={statusLName?.status}
                        message={statusLName?.message}
                        />
                </div>

                <div className='text-left text-sm mb-3 text-gray-500'>
                    Certifique-se de que corresponde ao nome no seu documento de identificação do governo.
                </div>
