            ...
            <div className='grid grid-cols-5 gap-2' >
                <div className='grid col-span-2 grid-rows-6 h-screen gap-2'>
                    <div className='row-span-3 p-2'>
                        ...
                        <div role="status" class="flex items-center justify-center h-full bg-gray-300 rounded-lg animate-pulse">
                    ...
                    <div className='row-span-2 p-2'>
                        ...
                        <div role="status" class="space-y-8 animate-pulse rounded-lg md:space-y-0 md:space-x-8 md:flex md:items-center">
                            <div class="w-full">
                                ...
                                <div class="h-2 bg-gray-200 rounded-full dark:bg-gray-700 max-w-[320px]"></div>
                            </div>
                            <span class="sr-only">Loading...</span>
                        </div>
                    ...
                    <div className='row-span-1'>
                        ...
                        <div role="status" class="p-4 space-y-4 border-gray-200 divide-y divide-gray-200 rounded animate-pulse">
                ...
                <div className='grid col-span-2 grid-rows-6 h-screen gap-2'>
                    <div className='row-span-1 p-2'>
                        ...
                        <div role="status" class="animate-pulse">
                            <div class="h-2.5 mx-auto bg-gray-300 rounded-full dark:bg-gray-700 max-w-[540px] mt-2.5"></div>
